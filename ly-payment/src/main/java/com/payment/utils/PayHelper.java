...
public class PayHelper {
    ...
    public void handleNotify(Map<String, String> msg) {
        ...
        //修改支付日志状态
        PayLog payLog = payLogMapper.selectByPrimaryKey(((Order) order).getOrderId());
        //未支付的订单才需要更改
